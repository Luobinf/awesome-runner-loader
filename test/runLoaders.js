...
describe("runLoaders", function () {
  it("should expose data at pitch phase", function (done) {
    runLoaders(
      {
        resource: path.resolve(fixtures, "resource.bin"),
        loaders: [
          path.resolve(fixtures, "simple-loader.js"),
          path.resolve(fixtures, "other-loader.js"),
        ],
      },
      function (err, result) {
  ...
  it("should process pitching loaders", function (done) {
    ...
    // simple-loader => pitching-loader => simple-async-loader => resource-file
    // remainingRequest = simple-async-loader!resource-file
    runLoaders(
      {
        resource: path.resolve(fixtures, "resource.bin"),
        loaders: [
      ...
      function (err, result) {
        ...
        // /Users/october/Desktop/Study/awesome-runner-loader/test/fixtures/simple-async-loader.js!/Users/october/Desktop/Study/awesome-runner-loader/test/fixtures/resource.bin:/Users/october/Desktop/Study/awesome-runner-loader/test/fixtures/simple-loader.js-simple
        result.result.should.be.eql([
          path.resolve(fixtures, "simple-async-loader.js") +
            "!" +
            path.resolve(fixtures, "resource.bin") +
  ...
  it("should have to correct keys in context", function (done) {
    runLoaders(
      ...
      function (err, result) {
        // console.log(9898888888876544444)
        // console.log(result)
        // console.log(9898888888876544444)
        if (err) return done(err);
        try {
  ...
  // 通过赋值 loaderIndex 跳过中间loader的pitch操作进而没有阅读中间的loader模块，
  //导致loader 的 normal属性为空，进而最后回过头执行的时候，没有执行中间被跳过的loader normal与pitch函数。
  ...
  it("should support escaping in resource", function (done) {
    console.log(9776);
    const a = path.resolve(fixtures, "res\0#ource.bin");
    console.log(a);
    console.log(9776);
    runLoaders(
      {
